...
class TestCommandInterpretationPerformance:
    ...
    def test_batch_command_interpretation_performance(
        self, chinese_commands, performance_monitor
    ):
...
class TestMemoryUsagePerformance:
    ...
    def test_memory_usage_with_command_execution(
        self, mock_ssh_client, performance_monitor
    ):
